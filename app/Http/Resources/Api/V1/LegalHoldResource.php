...
final class LegalHoldResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'release_justification' => $this->release_justification,
            'attachments' => LegalHoldActivityAttachmentResource::collection(
