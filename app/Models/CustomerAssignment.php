...
/**
 * Customer Assignment model for flexible user-to-customer role assignments.
 *
 * This model represents the flexible assignment of internal users to customers
 ...
 * use their own terminology (e.g., "Key Account Manager", "Sales Representative").
 *
 * Key Features:
