...
use App\Policies\WorkInstructionPolicy;
use App\Policies\WorkInstructionStandardBlockPolicy;
use App\Policies\WorkInstructionTemplatePolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(WorkInstruction::class, WorkInstructionPolicy::class);
        Gate::policy(WorkInstructionTemplate::class, WorkInstructionTemplatePolicy::class);
        Gate::policy(WorkInstructionStandardBlock::class, WorkInstructionStandardBlockPolicy::class);
