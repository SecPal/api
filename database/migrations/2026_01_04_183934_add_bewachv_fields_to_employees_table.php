...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('employees', function (Blueprint $table) {
            ...
            // Format: BWR-XXXXXXXX (assigned by authority after approval)
            $table->string('bwr_id', 50)->nullable()->unique()->after('employee_number');
            ...
            // BREAKING CHANGE: Replaces address_encrypted (kept for migration)
            // ═══════════════════════════════════════════════════════════════
