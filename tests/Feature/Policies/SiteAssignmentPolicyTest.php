 ...
 * @property SiteAssignmentPolicy $policy
 */
...
beforeEach(function (): void {
    ...
    $this->policy = new SiteAssignmentPolicy;
});
...
test('user assigned to site can view its assignments', function (): void {
    ...
    expect($this->policy->viewAny($user, $site))->toBeTrue();
});

test('user with permission and site update access can create assignments', function (): void {
    $user = User::factory()->create();
