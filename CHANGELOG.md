...
- replaced the Prettier and Markdownlint Node hooks with pinned npm hooks, so pre-commit no longer invokes its incompatible Node environment installer with current npm versions (fixes `api#1308`, `api#1309`)
