...
- required a non-empty `custom_type_name` when updating an organizational unit to `type: custom` or changing the name of an existing custom unit, matching the create contract (fixes `api#1262`)
