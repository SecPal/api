...
- hardened OpenTimestamp proof verification so Bitcoin attestations are validated against the corresponding fetched block header Merkle root before a proof is accepted, preventing forged detached timestamps with arbitrary Bitcoin attestation heights from being cached as valid
