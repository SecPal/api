...
- corrected wording in `ACTIVITY_LOGGING_USER_GUIDE.md`: "shipped" → "shipping", "hash-chain" → "hash chain", "at first render" → "immediately after creation on initial retrieval" for clarity and consistency with related guides
