...
- restored Dependabot pull request branch names to the standard slash-separated format in `.github/dependabot.yml`, so GitHub Actions, Composer, and npm update branches stay readable instead of flattening nested dependency paths into long hyphenated names
