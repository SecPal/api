...
- aligned OpenTimestamps calendar-submission documentation and script-level regression coverage with the Python runtime: it submits sequentially to the library calendar list, merges every successful response, and requires one successful response (fixes `api#1277`)
