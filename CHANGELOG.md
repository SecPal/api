...
- added a production-oriented, single-role-neutral API container image based on FrankenPHP Classic and PHP 8.4, including native PhpRedis/Valkey compatibility, rootless runtime permissions, explicit PostgreSQL and secret handling, Docker integration smoke coverage, CI, and operator documentation
