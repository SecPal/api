...
- added a native workflow artifact audit script with Pest coverage, so API, frontend, contracts, and Android can be checked together for active legacy local-container references while allowing historical changelog entries.
