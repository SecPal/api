...
- TDD is mandatory. Write or update the smallest relevant failing Pest test FIRST, then implement, then refactor with tests green.
...
- TDD happened: the relevant Pest test failed first and now passes
